!(function n(r, s, o) {
...
})(
  {
          ...
          var t = {
                        ...
                        s < 128
                          ...
                          : (s < 2048
                              ...
                              : (s < 55296
                                  ? n.push(224 | (s >> 12))
                                  : ((s = (1023 & s) << 10),
                                    (s |= 1023 & t.charCodeAt(++r)),
                                    n.push(240 | ((s += 65536) >> 18)),
                                    n.push(128 | ((s >> 12) & 63))),
                                n.push(128 | ((s >> 6) & 63))),
                            n.push(128 | (63 & s)));
                      }
            ...
            decode: function (t, d, y) {
              ...
              var e = (function e() {
                ...
                if ((t = L(n)) < 0 && (r < 2 || 6 < r)) throw "Invalid length";
                switch (r) {
                  case 0:
                    return t;
                  case 1:
      ...
      function (e, U, E) {
        !function (M, A) {
          !function () {
            ...
            function i(e, t) {
              for (
                var i = {}, n = e.length, r = t ? t.length : 0, s = 0;
                s < n;
                s++
              )
                i[e[s]] = s < r ? t[s] : g;
            ...
            function m(e, t, i, n) {
              ...
              if (e) {
                ...
                for (
                  var s, o, a, c = Object.keys(e), l = c.length, u = 0;
                  u < l;
                  u++
                ) {
                  if (((s = c[u]), !n && !b.call(t, s)))
                    throw Error('Unknown "' + s + '" option');
                  (o = e[s]) !== g && ((a = i[s]), (r[s] = a ? a(o, h) : o));
                }
              }
              return r;
              function h(e) {
            ...
            function _(e, t, i, n, r) {
              ...
              if (((s = i["*"]) && _(e, t, s, n + 1, r), (p = i["**"])))
                if (n < r)
                  for (
                    p._listeners && _(e, t, p, r, r), a = (d = L(p)).length;
                    0 < a--;
                  )
                    "_listeners" !== (f = d[a]) &&
                      (f === w
            ...
            function u(e, t, i, n) {
              for (
                var r, s, o, a = L(e), c = a.length, l = e._listeners;
                0 < c--;
              )
                ((r = e[(o = a[c])]),
            ...
            function d(e) {
              for (var t, i, n, r = L(e), s = r.length; 0 < s--; )
                (t = e[(i = r[s])]) &&
            ...
            ((b = Object.hasOwnProperty),
              ...
              (T = "object" == typeof M && "function" == typeof M.nextTick),
                  ...
                  n !== g &&
                    ((t = (n = function (e, t, i) {
                      ...
                      if (n || s || r) {
                        ...
                        (r === g &&
                          (r = "AsyncFunction" === t.constructor.name),
                          ((t = function () {
                            var e = arguments,
                              t = this,
                              i = this.event;
              ...
              (r.prototype.removeAllListeners = function (e) {
                if (e === g) this._events && h.call(this);
              ...
              (r.prototype.listeners = function (e) {
                ...
                if (!c) return [];
                for (r = (t = L(c)).length, n = []; 0 < r--; )
                  "function" == typeof (i = c[t[r]])
                    ? n.push(i)
                    : n.push.apply(n, i);
                return n;
              }),
              ...
              (r.prototype.hasListeners = function (e) {
                ...
                return this.wildcard
                  ...
                  : ((t = this._events),
                    !!(
                      ((i = this._all) && i.length) ||
                      (t && (e === g ? L(t).length : t[e]))
                    ));
              }),
                      ...
                      function (e, t, i) {
                        ...
                        "function" == typeof o.addEventListener
                          ? ((n = function () {
                            ...
                            o.addEventListener(a, n, { once: !0 }))
                          : ((r = function () {
                              (s && o.removeListener("error", s),
                                e(l.apply(null, arguments)));
                            }),
                            "error" !== a &&
                              ((s = function (e) {
                                (o.removeListener(a, r), t(e));
                              }),
                              o.once("error", s)),
                            i(function () {
                              (s && o.removeListener("error", s),
                                o.removeListener(a, r));
                            }),
                            o.once(a, r));
                      },
    ...
    4: [
      function (e, t, i) {
        ...
        function f() {
          u &&
            c &&
            ((u = !1), c.length ? (l = c.concat(l)) : (h = -1), l.length) &&
            p();
        }
        function p() {
          if (!u) {
        ...
        t.exports = function (e, t) {
          ...
          return (
            t.bare ||
              ...
              ((e = new window.Worker(t)).objectURL = t)),
            e
          );
        };
      },
      ...
      function (e, t, i) {
        ...
        t.exports = function (e, t) {
          ...
          var u =
              ...
              v(l) +
              "])",
            l = window.URL || window.webkitURL || window.mozURL || window.msURL,
            u = new Blob([u], { type: "text/javascript" });
          return t && t.bare
            ? u
            : ((t = l.createObjectURL(u)),
              ((l = new Worker(t)).objectURL = t),
              l);
        };
      },
      {},
    ...
    8: [
      function (e, t, i) {
        var n = this.ROSLIB || { REVISION: "1.4.1" },
          r = e("object-assign");
        (r(n, e("./core")),
          r(n, e("./actionlib")),
          r(n, e("./math")),
        ...
        ((n.prototype.get = function (t, e) {
          ...
          (n.prototype.set = function (e, t, i) {
            var n = new r({
              ...
              e = new s({ name: this.name, value: JSON.stringify(e) });
            n.callService(e, t, i);
          }),
